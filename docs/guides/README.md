...
- [Customizing the UI](customizing-ui.md) - Creating custom [themes](../reference/glossary.md#theme) and layouts
...
- [Pagination and Caching](pagination-and-caching.md) - Best practices for async pagination with intelligent caching

## Workflow Guides

- [Plugin Development Workflow](plugin-workflow.md) - Best practices for plugin development
- [Theme Development Workflow](theme-workflow.md) - Creating and testing custom [themes](../reference/glossary.md#theme)
- [Contributing to Movian](contributing-to-movian.md) - How to contribute to the core project

## Platform-Specific Guides

- [Android Development](android-development.md) - Building for Android
- [iOS Development](ios-development.md) - Building for iOS
- [Desktop Development](desktop-development.md) - Windows, Linux, macOS specifics